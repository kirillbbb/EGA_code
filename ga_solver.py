...
PairingMode = Literal["negative_associative", "random"]
...
def solve_ga(instance: KnapsackInstance, cfg: GAConfig, pairing_mode: PairingMode) -> KnapsackSolution:
    ...
    for _ in range(cfg.generations):
        ...
        while len(offspring) < cfg.offspring_size:
            ...
            parent2 = select_partner(parent1, population, pairing_mode, rng)
